...
public class Inputtokobaju extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_tb);
        ...
        btnKirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inputtokobaju(strid, strnama, strpassword, stremail, stralamat, strnohp);
            }
        });
    }

    private void inputtokobaju(String id, String nama, String password, String email, String alamat, String nohp){
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(status == true){
                                ...
                                msg = response.getString("pesan");
                                Intent i = new Intent(Inputtokobaju.this,
                                        MainActivity.class);
                                startActivity(i);
                                finish();
                            }
    ...
    public void onBackPressed() {
        Intent i = new Intent(Inputtokobaju.this, MainActivity.class);
        startActivity(i);
        finish();
    }
}
