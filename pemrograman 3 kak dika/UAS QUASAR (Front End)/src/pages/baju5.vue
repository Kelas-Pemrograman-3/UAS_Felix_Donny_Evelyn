...
<div class="q-pa-md">
    ...
    <div class="row justify-center q-pt-md">
      <div class="col-md-5 col-xs-12">
        <q-card flat>
          <q-card-section>
            <div class="text-h4 q-pb-md text-center text-black"><b>Baju Lengan Pendek Garis Rp.200.000</b></div>
            <q-form
      @submit="onSubmit"
      @reset="onReset"
      class="q-gutter-sm"
