...
<div class="q-pa-md">
    ...
    <div class="q-pa-md">
    <q-img
    src="statics/baju3.jpg"
    spinner-color="white"
    style="height: 450px; max-width: 420px"
    img-class="my-custom-image"
    class="rounded-borders">
    <div class="absolute-bottom text-subtitle1 text-center">
        <h9>Tampilan Depan</h9>
    </div>
    </q-img>
    <q-img
    src="statics/baju31.jpg"
    spinner-color="white"
    style="height: 450px; max-width: 420px"
    img-class="my-custom-image"
    class="rounded-borders">
    <div class="absolute-bottom text-subtitle1 text-center">
        <h9>Tampilan Belakang</h9>
    </div>
    </q-img>
    <q-img
    src="statics/baju32.jpg"
    spinner-color="white"
    style="height: 450px; max-width: 420px"
    img-class="my-custom-image"
    class="rounded-borders">
    <div class="absolute-bottom text-subtitle1 text-center">
        <h9>Macam-Macam Warna</h9>
    </div>
    </q-img>
    <q-page>
    ...
    <div class="col-md-5 col-xs-12">
        <q-card flat>
        <q-card-section>
            <div class="text-h4 q-pb-md text-center text-black"><b>Baju Lengan Panjang Tali Rp.210.000</b></div>
            <q-form
    @submit="onSubmit"
    @reset="onReset"
    class="q-gutter-sm"
